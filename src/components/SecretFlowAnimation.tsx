    ...
    <div className="w-full max-w-[500px] mx-auto select-none">
      <div className="rounded-3xl bg-[#090D15] border border-[#1E2638] shadow-[0_20px_50px_rgba(0,0,0,0.6)] p-6 relative overflow-hidden backdrop-blur-xl">
        ...
        <div className="grid grid-cols-2 gap-4 relative py-2">
          ...
          {/* Node 1: Local Vault */}
          <div className="rounded-2xl bg-[#0B1320] border border-emerald-500/30 p-5 flex flex-col items-center justify-between min-h-[220px]">
            ...
            <div className="my-auto flex flex-col items-center">
              <div className="relative w-16 h-20 rounded-xl bg-[#0D1C2C] border-2 border-emerald-400/80 flex flex-col items-center justify-center shadow-[0_0_20px_rgba(16,185,129,0.2)]">
                <div className="w-10 h-1.5 bg-emerald-400/80 rounded mb-1" />
                <div className="w-8 h-1 bg-slate-400/50 rounded mb-1" />
                <div className="w-6 h-1 bg-slate-400/30 rounded" />
                <Lock className="w-3.5 h-3.5 text-emerald-300 mt-2" />
              </div>
              <span className="text-xs font-semibold text-white mt-3">{isZh ? '真实数据资产' : 'Raw Data'}</span>
            </div>

            <div className="text-[11px] font-mono text-emerald-400/90 text-center">
          ...
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10 flex flex-col items-center">
            <div className="w-10 h-10 rounded-full bg-[#080B12] border border-cyan-400 shadow-[0_0_20px_rgba(0,242,254,0.4)] flex items-center justify-center text-[10px] font-mono font-bold text-cyan-300">
              P·X
            </div>
          </div>

          {/* Node 2: Cloud AI */}
          <div className="rounded-2xl bg-[#120F24] border border-cyan-500/30 p-5 flex flex-col items-center justify-between min-h-[220px]">
            ...
            <div className="my-auto flex flex-col items-center">
              <div className="w-16 h-20 rounded-xl bg-[#191533] border-2 border-cyan-400/80 flex flex-col items-center justify-center shadow-[0_0_20px_rgba(0,242,254,0.2)]">
            ...
            <div className="flex items-center gap-1 text-[11px] font-mono text-cyan-400 text-center">
        ...
        <div className="mt-4 pt-4 border-t border-[#1E2638] flex items-center justify-between text-xs">
          ...
          {onExploreTechnology && (
            <button
              ...
              className="text-cyan-400 hover:text-cyan-300 text-xs font-mono font-medium flex items-center gap-0.5 cursor-pointer shrink-0 ml-3"
            >
